    ...
    questions: [
      {
        ...
        answer: 0,
        explanation: "HTML mendefinisikan struktur konten, CSS mengatur tampilan/style, dan JavaScript menangani logika & interaktivitas.",
      },
      {
        id: "wb2",
        ...
        answer: 0,
        explanation: "Responsive design memastikan tampilan website tetap optimal di berbagai ukuran layar (desktop, tablet, mobile).",
      },
      {
        id: "wb3",
        ...
        answer: 2,
        explanation: "DOM adalah representasi tree dari dokumen HTML yang bisa diakses dan dimanipulasi menggunakan JavaScript.",
      },
      {
        id: "wb4",
        ...
        answer: 1,
        explanation: "Tag <script> digunakan untuk menyisipkan atau me-link file JavaScript ke dalam dokumen HTML.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer: 1,
        explanation: "var memiliki function scope dan bisa di-redeclare. let memiliki block scope dan bisa di-reassign. const memiliki block scope dan tidak bisa di-reassign (nilai primitif).",
      },
      {
        id: "js2",
        ...
        answer: 2,
        explanation: "Ini adalah bug terkenal di JavaScript! typeof null mengembalikan 'object', bukan 'null'. Ini adalah perilaku yang dipertahankan karena backward compatibility.",
      },
      {
        id: "js3",
        ...
        answer: 1,
        explanation: "async/await adalah syntax sugar di atas Promise. Kode async terlihat seperti synchronous, membuatnya lebih mudah dibaca, tapi tetap non-blocking.",
      },
      {
        id: "js4",
        ...
        answer: 1,
        explanation: "Callback adalah fungsi yang diteruskan ke fungsi lain sebagai argumen, yang kemudian dijalankan setelah operasi tertentu selesai.",
      },
      {
        id: "js5",
        ...
        answer: 1,
        explanation: ".map() membuat array baru dengan menerapkan fungsi ke setiap elemen. Hasilnya adalah [2, 4, 6].",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer: 1,
        explanation: "TypeScript adalah superset dari JavaScript — semua kode JS valid di TS. TS menambahkan type annotations yang di-compile menjadi JS biasa.",
      },
      {
        id: "ts2",
        ...
        type: "multiple",
        options: [
          "Kode berjalan lebih cepat saat runtime",
          "Tidak perlu lagi belajar JavaScript",
          "Error bisa terdeteksi saat development (compile time) sebelum kode dijalankan",
          "File JavaScript menjadi lebih kecil ukurannya",
        ],
        answer: 2,
        explanation: "TypeScript mendeteksi type errors saat compile time (saat kamu menulis kode), bukan saat runtime. Ini mencegah banyak bug sebelum mencapai production.",
      },
      {
        id: "ts3",
        ...
        answer: 1,
        explanation: "name: string berarti parameter name harus bertipe string. : string setelah kurung berarti return type-nya string. TypeScript akan error saat compile jika tipe tidak cocok.",
      },
      {
        id: "ts4",
        ...
        answer: 1,
        explanation: "Interface mendefinisikan 'kontrak' — bentuk objek yang diharapkan. Sangat berguna untuk mendefinisikan tipe data yang kompleks dan memastikan konsistensi.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer: 0,
        explanation: "Vibe coding adalah cara membuat kode dengan mengandalkan AI untuk mengubah deskripsi natural language menjadi kode kerja.",
      },
      {
        id: "ai2",
        ...
        answer: 0,
        explanation: "Tool vibe coding membantu programmer membuat kode dengan prompt dan saran AI, tetapi hasilnya tetap harus ditinjau dan diuji.",
      },
      {
        id: "ai3",
        ...
        answer: 0,
        explanation: "Claude Code dirancang sebagai alat coding agent yang mampu bekerja dengan file dan terminal, berbeda dari chat AI yang hanya memberi jawaban teks.",
      },
      {
        id: "ai4",
        ...
        answer: 0,
        explanation: "Copilot dibangun di atas Codex untuk mendukung autocompletion kode dan membantu programmer menulis kode lebih cepat dengan saran kontekstual.",
      },
      {
        id: "ai5",
